...
"color: rgb(27, 160, 25);\n"
""));
        user->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignTop);
        user->setFlat(false);
...
"color: rgb(27, 160, 25);\n"
""));
        Password->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignTop);
...
"color: #A2A1A8"));
        Sub_title->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
...
"border-radius:20px;\n"
""));
        go_to_face_recog = new QPushButton(widget_2);
        go_to_face_recog->setObjectName(QString::fromUtf8("go_to_face_recog"));
        go_to_face_recog->setGeometry(QRect(90, 450, 311, 41));
        go_to_face_recog->setFont(font1);
        go_to_face_recog->setCursor(QCursor(Qt::PointingHandCursor));
        go_to_face_recog->setStyleSheet(QString::fromUtf8("background-color: rgb(27, 160, 25);\n"
"color: rgb(255, 255, 255);\n"
"border-radius:10px;"));
        go_to_face_recog->setCheckable(false);
        go_to_face_recog->setAutoRepeat(false);
        go_to_face_recog->setAutoDefault(false);
        go_to_face_recog->setFlat(false);
...
""));
        ...
        image_preview->setFrameShape(QFrame::Box);
...
"border-radius:10px;"));
        ...
        Sub_title_4->setLayoutDirection(Qt::LeftToRight);
        Sub_title_4->setStyleSheet(QString::fromUtf8("background-color:transparent;\n"
"color: #A2A1A8"));
        Sub_title_4->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
...
"color: rgb(27, 160, 25);\n"
""));
        user_2->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignTop);
...
"color: rgb(27, 160, 25);\n"
""));
        emaill_field->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignTop);
...
"color: rgb(27, 160, 25);\n"
""));
        Password_2->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignTop);
...
"color: rgb(27, 160, 25);\n"
""));
        img_field->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignTop);
...
"border-width : 0x;\n"
"color:grey;"));
        img_name->setEchoMode(QLineEdit::Normal);
...
"color: rgb(27, 160, 25);\n"
""));
        user_3->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignTop);
...
"border-radius:10px;"));
        ...
        Sub_title_3->setLayoutDirection(Qt::LeftToRight);
        Sub_title_3->setStyleSheet(QString::fromUtf8("background-color:transparent;\n"
"color: #A2A1A8"));
        Sub_title_3->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
...
"border-style:solid;"));
        ...
        Sub_title_5->setLayoutDirection(Qt::LeftToRight);
        Sub_title_5->setStyleSheet(QString::fromUtf8("background-color:transparent;\n"
"color: #A2A1A8"));
        Sub_title_5->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
...
""));
        ...
        go_to_face_recog->setDefault(false);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        go_to_face_recog->setText(QCoreApplication::translate("MainWindow", "Use Face Recognition", nullptr));
