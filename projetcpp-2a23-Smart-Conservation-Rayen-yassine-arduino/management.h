...
private slots:
    ...
    //MACHINE
    void goToAddNewMachine();
    void goToUpdateMachine();
    void goToDiagnosis();
    void goToPlanMaintenance();
    void goToHomePage(); // Slot to go back to Page 1
    ...
    void on_searchLocation_2_textChanged(const QString &searchText);
    ...
    void on_ajout_f_2_clicked();

    void on_annuler_6_clicked();

    void on_sup_3_clicked();

    void on_delate_f_2_cursorPositionChanged(int arg1, int arg2);
    ...
    void on_update_7_clicked();

    void on_annuler_3_clicked();

    void on_update_5_clicked();

    void on_staticbutton_clicked();

    void on_filterButton_2_clicked();

    void on_generateQRCodeButton_2_clicked();

    void on_displayQRButton_2_clicked();

    void on_progressBarStatistics_valueChanged(int value);

    void on_search_9_clicked();


    void on_totalFactoriesLabel_2_linkActivated(const QString &link);

    void on_PDF_2_clicked();

    //--------------------------arduinoFM
    void updateProgressBarsFM();
    void on_setThresholdButton_clicked();
    void on_saveTMToButton_clicked();
...
private:
    ...
    void on_searchLocation_2_textChangedF(const QString &searchText);
    /////--------------------------------------client
    client cl;
    arduino A;
    ...
    // Function to initialize Arduino connection
    void initializeArduinoFM();
    void initializePeriodicUpdates();

    // Timer for periodically reading data from Arduino
